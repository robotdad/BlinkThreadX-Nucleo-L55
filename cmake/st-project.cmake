...
# BASED ON c:\source\ewprep\BlinkThreadX-Nucleo-L55
...
target_compile_definitions(
    ...
    "$<$<AND:$<CONFIG:Debug>,$<COMPILE_LANGUAGE:ASM>>:TX_SINGLE_MODE_NON_SECURE>"
    "$<$<AND:$<CONFIG:Debug>,$<COMPILE_LANGUAGE:C>>:DEBUG>"
    "$<$<AND:$<CONFIG:Debug>,$<COMPILE_LANGUAGE:C>>:USE_FULL_LL_DRIVER>"
    "$<$<AND:$<CONFIG:Debug>,$<COMPILE_LANGUAGE:C>>:TX_SINGLE_MODE_NON_SECURE>"
    ...
    "$<$<AND:$<NOT:$<CONFIG:Debug>>,$<COMPILE_LANGUAGE:ASM>>:TX_SINGLE_MODE_NON_SECURE>"
    "$<$<AND:$<NOT:$<CONFIG:Debug>>,$<COMPILE_LANGUAGE:C>>:USE_FULL_LL_DRIVER>"
    "$<$<AND:$<NOT:$<CONFIG:Debug>>,$<COMPILE_LANGUAGE:C>>:TX_SINGLE_MODE_NON_SECURE>"
...
target_sources(
    ...
    "Middlewares\\ST\\threadx\\ports\\cortex_m33\\gnu\\src\\tx_thread_interrupt_disable.S"
    "Middlewares\\ST\\threadx\\ports\\cortex_m33\\gnu\\src\\tx_thread_interrupt_restore.S"
